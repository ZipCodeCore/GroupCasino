...
public class Yahtzee implements Game {
    ...
    public void chooseToKeep() {
        ...
        while (!keepthis.toLowerCase().equals("roll")) {
            ...
            switch (keepthis) {
                case "1":
                    this.myDice[0].keptOrRolled();
                    break;
                case "2":
                    this.myDice[1].keptOrRolled();
                    break;
                case "3":
                    this.myDice[2].keptOrRolled();
                    break;
                case "4":
                    this.myDice[3].keptOrRolled();
                    break;
                case "5":
                    this.myDice[4].keptOrRolled();
                    break;
                case "continue":
                    keepthis = "roll";
                    break;
    ...
    public int checkForEvaluation() {
        ...
        switch (choice) {
            case 1:
                return checkForFaces(diceValues, 1);
            case 2:
                return checkForFaces(diceValues, 2);
            case 3:
                return checkForFaces(diceValues, 3);
            case 4:
                return checkForFaces(diceValues, 4);
            case 5:
                return checkForFaces(diceValues, 5);
            case 6:
                return checkForFaces(diceValues, 6);
            case 7:
                return checkFor3Kind(diceValues);
            case 8:
                return checkFor4Kind(diceValues);
            case 9:
                return checkForSmallStraight(diceValues);
            case 10:
                return checkForLargeStraight(diceValues);
            case 11:
                return checkForFullHouse(diceValues);
            case 12:
                return checkForYahtzee(diceValues);
            case 13:
